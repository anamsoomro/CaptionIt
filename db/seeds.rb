...
Caption.create(text: Faker::Quote.famous_last_words, user_id: User.third.id, comic_id: Comic.first.id, likes: 0)
Caption.create(text: Faker::Quote.matz, user_id: User.first.id, comic_id: Comic.fifth.id, likes: 5)
