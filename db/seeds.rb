...
satirics = Topic.create(label: "satire" )
politics = Topic.create(label: "politics" )
celebrities = Topic.create(label: "celebrities" )
...
3.times do 
  ...
  Comic.create(image_url: "https://mymodernmet.com/wp/wp-content/uploads/archive/v9r0zDhCCVu3YJuKrEh1_pawelkuczynski2.jpg", user_id: User.first.id)
...
3.times do 
  # Comic.create(image_url: suckr.get_image_url({"q" => "politics"}), user_id: User.second.id)
  # Comic.create(image_url: RandomImages::Image.get("politics", "any"), user_id: User.first.id)
...
3.times do 
  # Comic.create(image_url: suckr.get_image_url({"q" => "animals"}), user_id: User.fourth.id )
  # Comic.create(image_url: RandomImages::Image.get("animals", "any"), user_id: User.first.id)
  Comic.create(image_url: "https://i.insider.com/5c79b7e2eb3ce83af24c4403?width=1100&format=jpeg&auto=webp", user_id: User.first.id)
  Comic.create(image_url: "https://i.ytimg.com/vi/O5d1R7G3-wk/maxresdefault.jpg", user_id: User.first.id)
  Comic.create(image_url: "https://i.ytimg.com/vi/mAX9qzX_LQU/maxresdefault.jpg", user_id: User.first.id)
end

3.times do 
  # Comic.create(image_url: suckr.get_image_url({"q" => "technology"}), user_id: User.fifth.id)
  # Comic.create(image_url: RandomImages::Image.get("technology", "any"), user_id: User.first.id)
  ...
  Comic.create(image_url: "https://img1.grunge.com/img/gallery/secret-code-words-that-no-one-is-supposed-to-know/intro-1554929306.jpg", user_id: User.first.id)
...
Caption.create(text: Faker::Quote.famous_last_words, user_id: User.third.id, comic_id: Comic.first.id)
Caption.create(text: Faker::Quote.matz, user_id: User.first.id, comic_id: Comic.fifth.id)
Caption.create(text: Faker::Quote.most_interesting_man_in_the_world, user_id: User.fifth.id, comic_id: Comic.fifth.id)
Caption.create(text: Faker::Quote.singular_siegler, user_id: User.fourth.id, comic_id: Comic.second.id)
Caption.create(text: Faker::Quote.yoda, user_id: User.fifth.id, comic_id: Comic.third.id)
